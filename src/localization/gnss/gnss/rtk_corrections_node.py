...
class ntrip_client(Node):
    def __init__(self):
        ...
        self.declare_parameter('serial_baud', 1125200)
        ...
        self.server = self.get_parameter('port').get_parameter_value().integer_value
    ...
    def ntrip_connect(self) -> socket.socket:
        ...
        s.sendall(self._build_ntrip_request())
    ...
    def build_ntrip_request(self):
        ...
        req_lines = [
            ...
            f"Host: {self.server}",
            f"User-Agent: ROS2NTRIPClient {self.ntrip_version}",
            "Accept: */*",
