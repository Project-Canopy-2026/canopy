...
#
#  Command format:
# FIXME: might need to change to tkaing in a speed and a position instead of duration
...
# FIXME: instead of timed move, it should be after the go-to-position is achieved 
...
# ============================================================
#  position codes  (same across CANopen and J1939)
# ============================================================
CMD_STOP        = 64259   # 0xFB03
CMD_CLEAR_ERROR = 64256   # 0xFB00
CMD_RUN_OUT     = 64257   # 0xFB01  into soil / ground
CMD_RUN_IN      = 64258   # 0xFB02  retract
# ============================================================
...
# ============================================================
#  LINAK_1 for Auger - CANopen  (can0, 125 kbps, Node ID 0x20)
# ============================================================
