...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            # 'manual_fsm_tester = planting_controller.manual_fsm_tester:main',   # moved to ARCHIVE
            # 'planting_fsm_outmax = planting_controller.planting_fsm_outmax:main', # moved to ARCHIVE
